...
let kCircleHeightBackground: CGFloat = 60.0//modifalert
...
open class SCLAlertView: UIViewController {
    ...
    fileprivate func setup() {
        ...
        // Circle View
        circleBG.backgroundColor = UIColor.init(red: 1/255, green: 69/255, blue: 118/255, alpha: 1).withAlphaComponent(0.8)//modifalert
        ...
        viewText.backgroundColor = UIColor.clear//appearance.contentViewColor
    ...
    override open func viewWillLayoutSubviews() {
        ...
        circleBG.frame = CGRect(x:x-contentView.frame.width/2+(kCircleHeightBackground*1/6), y:y+6-(kCircleHeightBackground/2)+(kCircleHeightBackground*2/3), width:kCircleHeightBackground, height:kCircleHeightBackground)
        //modifalert
    ...
    open func addButton(_ title:String, backgroundColor:UIColor? = nil, textColor:UIColor? = nil, showDurationStatus:Bool=false, action:@escaping ()->Void)->SCLButton {
        ...
        btn.layer.borderColor = UIColor.white.cgColor//modifalert
    ...
    open func showTitle(_ title: String, subTitle: String, duration: TimeInterval?, completeText: String?, style: SCLAlertViewStyle, colorStyle: UInt?=0x000000, colorTextButton: UInt?=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: SCLAnimationStyle = .topToBottom) -> SCLAlertViewResponder {
        ...
        if appearance.showCloseButton {
            _ = addButton(completeText ?? "Retour", target:self, selector:#selector(SCLAlertView.hideView))
        }
        ...
        circleView.backgroundColor = UIColor.clear//viewColor//modifalert
        // Spinner / icon
        if style == .wait {
